...
<head>
    ...
    <link rel="stylesheet" href="mainNoticias.css">
    <title>Inicio</title>
</head>
<body>
    <?php 
...
<main>
    ...
    <div class="contenedornoticias">
        ...
        <?php foreach($noticias as $noticia):?>
            <div class="noticia">
                <div class="imgfondonoticia">
                            <img src="Imagenes/fondonoticia.png" alt="">
                        </div>
                <div class="columnacontenido">
                        ...
                        <p id='fecha'><?php echo $noticia->FECHA ?></p>
                        <p id='categoria'><a href="<?php echo $noticia->LINK ?>"> Link </a></p>
                </div>
                <div class="columnaimg">
                        <img src="Imagenes/<?php echo $noticia->IMG ?>" alt="">
                </div>    
            </div>
            <?php endforeach; ?>
        </div>
